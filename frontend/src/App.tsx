...
import { CATALOG, FEATURED, GENRES, MARQUEE, PICKS, PRODUCTS, money, parseGenres, productById, type Filter, type Product } from './data'
  ...
  return (
    <>
      ...
      {isCatalog ? (
        ...
        <ProductPage id={productId} onAdd={addItem} />
